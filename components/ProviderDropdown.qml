...
// (which sits outside the popup) does not close-and-reopen it. Clicking the
// trigger now deterministically toggles the popup. Visuals and keyboard are
// otherwise identical to the native component.
//
  ...
  Column {
    ...
    BorderSurface {
      ...
      Popup {
        ...
        focus: true
        // CloseOnPressOutside removed: a press on the trigger lives outside the
        // popup, and with it enabled the trigger's toggle closes-then-reopens.
        // The trigger click, a selection, and Esc are the close paths now.
